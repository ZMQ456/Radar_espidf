...
typedef struct {
    ...
    uint8_t turn_count;
    uint8_t large_move_ratio;
    uint8_t small_move_ratio;
    int16_t pos_x;
    int16_t pos_y;
    int16_t pos_z;
    int8_t breath_waveform[5];
    int8_t heart_waveform[5];
    uint16_t deep_sleep_time;
    uint16_t light_sleep_time;
    uint16_t awake_time;
    uint16_t sleep_total_time;
    uint8_t deep_sleep_ratio;
    uint8_t light_sleep_ratio;
    uint8_t awake_ratio;
    uint8_t turnover_count;
    uint8_t struggle_alert;
    uint8_t no_one_alert;
    uint8_t bed_status;
    uint8_t bed_Out_Time;
    uint8_t apnea_count;
